...
public class CommentRepository {
    ...
    //Get an instance of EntityManagerFactory
    ...
    //This method executes Query to fetch all the comments from the database
    //based on Image id and returns the list of all the comments fetched from the database
